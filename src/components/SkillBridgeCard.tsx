  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-sm space-y-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-base font-bold text-slate-900">Skill Gap Remediation & Free Project Hub</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {missingSkills.slice(0, 6).map((skill, idx) => (
          <div
            key={idx}
            className="p-4 rounded-xl bg-slate-50 border border-slate-200/70 hover:border-emerald-200 transition-all space-y-2"
          >
            <div className="flex items-center justify-between">
              <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-emerald-100 text-emerald-900">
                {skill}
              </span>
              <span className="text-[11px] font-medium text-slate-400">Missing Gap</span>
            </div>
            ...
            <div className="flex items-center gap-2 pt-1">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-[11px] font-bold text-red-600 hover:text-red-700 bg-red-50 px-2.5 py-1 rounded-lg border border-red-100 flex items-center gap-1 transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-[11px] font-bold text-slate-800 hover:text-slate-900 bg-slate-200/70 px-2.5 py-1 rounded-lg flex items-center gap-1 transition-colors"
              >
                🐙 GitHub Projects
              </a>
            </div>
