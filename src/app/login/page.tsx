  ...
  return (
    <div className="min-h-[100dvh] h-full flex items-center justify-center p-3 sm:p-6 lg:p-8 bg-[#09090B] text-[#FAFAFA] overflow-y-auto sm:overflow-hidden">
      <div className="w-full max-w-5xl bg-[#18181B] border border-[#27272A] rounded-2xl sm:rounded-3xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 my-auto">
        {/* LEFT PANEL: Interactive Authentication Form (Reduced mobile box padding) */}
        <div className="lg:col-span-7 p-4 sm:p-8 lg:p-12 flex flex-col justify-between space-y-3.5 sm:space-y-5">
          {/* Header & Logo */}
          <div className="space-y-2.5 sm:space-y-3">
            ...
            <div>
              ...
              <p className="text-[11px] sm:text-xs text-zinc-400 font-medium mt-0.5">
                Sign in to manage your career tools, tests, and pipeline.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2.5 sm:space-y-3">
            ...
            {/* Horizontal Divider */}
            <div className="flex items-center gap-2.5 my-1.5 w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-2.5 sm:space-y-3.5">
            {error && (
              <div className="p-2.5 sm:p-3 rounded-xl bg-rose-950/40 border border-rose-800 text-[11px] sm:text-xs text-rose-300 font-bold animate-in fade-in">
                ⚠️ {error}
              </div>
            )}
            ...
            <div>
              <label
                htmlFor="email"
                className="block text-[11px] sm:text-xs font-bold text-zinc-300 mb-1"
              >
                Email Address
              </label>
              <input
                ...
                className="w-full px-3.5 py-2 sm:py-2.5 rounded-xl text-xs bg-[#09090B] border border-[#27272A] text-[#FAFAFA] placeholder-zinc-500 focus:border-[#FAFAFA] outline-none transition-all font-medium"
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  ...
                  className="text-[10px] sm:text-[11px] font-bold text-zinc-400 hover:text-[#FAFAFA] transition-colors cursor-pointer"
                >
            ...
            <button
              ...
              className="touch-target min-h-[40px] sm:min-h-[44px] w-full py-2.5 sm:py-3 bg-[#FAFAFA] hover:bg-zinc-200 text-[#09090B] font-bold text-xs uppercase tracking-wider rounded-xl transition-all active:scale-95 disabled:opacity-50 cursor-pointer flex items-center justify-center gap-2 border border-[#FAFAFA] mt-1"
            >
              {loading ? (
                <>
          ...
          {/* Footer Note */}
          <p className="text-center text-[10px] sm:text-[11px] text-zinc-400 pt-1.5 border-t border-[#27272A]">
        ...
        <div className="hidden lg:flex lg:col-span-5 bg-[#09090B] text-[#FAFAFA] p-8 lg:p-10 flex-col justify-between relative overflow-hidden border-l border-[#27272A]">
          ...
          <div className="space-y-3 relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#18181B] border border-[#27272A] rounded-full text-[10px] font-bold uppercase text-zinc-300">
              ...
              Universal Talent Operating System
            </div>

            <h3 className="text-xl font-bold tracking-tight leading-snug text-[#FAFAFA]">
              The 1-Stop Talent Operating System for Every Role
            </h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
              Accelerate your career journey with ATS-optimized resumes, coding challenges, spoken video mocks, and salary simulations.
            </p>
          </div>
          ...
          <div className="p-5 bg-[#18181B] border border-[#27272A] rounded-2xl space-y-2.5 relative z-10">
            ...
            <p className="text-xs text-zinc-300 italic font-medium leading-relaxed">
              &ldquo;paniund transformed my application strategy and helped me land 3 competitive offer letters in under 3 weeks.&rdquo;
            </p>
            <div className="pt-2 border-t border-[#27272A] flex items-center justify-between text-[10px]">
              ...
              <span className="text-zinc-500 font-mono">Senior Engineer</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 relative z-10 pt-3 border-t border-[#27272A] text-xs">
            <div>
              <div className="text-lg font-bold font-mono text-[#FAFAFA]">98.4%</div>
              <span className="text-[9px] text-zinc-400 uppercase font-bold">ATS Pass Rate</span>
            </div>
            <div>
              <div className="text-lg font-bold font-mono text-[#FAFAFA]">140k+</div>
              <span className="text-[9px] text-zinc-400 uppercase font-bold">Matched Jobs</span>
            </div>
          </div>
        </div>
      </div>
