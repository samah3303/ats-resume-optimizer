  ...
  return (
    <div className="min-h-screen bg-[#09090B] text-[#FAFAFA] py-8 px-4 sm:px-6 lg:px-8 space-y-6 pb-24">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Header Banner */}
        <div className="bg-[#18181B] rounded-3xl border border-[#27272A] p-6 sm:p-8 text-[#FAFAFA] shadow-sm space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-black uppercase tracking-wider bg-[#27272A] border border-[#27272A] text-[#FAFAFA] shadow-sm">
                <span>🗺️ Core Feature</span>
                <span>•</span>
                <span>8-Week Action Blueprint</span>
              </div>
              <h1 className="text-2xl sm:text-4xl font-black mt-3 tracking-tight text-[#FAFAFA]">
            ...
            >
              {isRegenerating ? (
                <>
                  <div className="w-4 h-4 border-2 border-[#FAFAFA] border-t-transparent rounded-full animate-spin" />
                  Generating...
                </>
              ) : (
          ...
          <div className="pt-6 border-t border-[#27272A]">
            <div className="flex items-center justify-between text-xs font-bold mb-2">
              <span className="text-zinc-400 uppercase tracking-wider">Roadmap Completion Progress</span>
              <span className="text-[#FAFAFA] font-mono font-bold">{progressPct}% Complete</span>
            </div>
            <div className="w-full h-3 rounded-full bg-[#27272A] overflow-hidden p-0.5 border border-[#27272A]">
              <div
        ...
        {statusMessage && (
          <div className="p-4 rounded-2xl text-xs font-bold bg-[#27272A] text-[#FAFAFA] border border-[#27272A] shadow-sm">
            {statusMessage}
          </div>
        )}
        ...
        {roadmap?.strategyOverview && (
          <div className="bg-[#18181B] border border-[#27272A] rounded-3xl p-6 shadow-sm space-y-2">
              ...
              <button
                ...
                className={`px-4 py-2.5 rounded-2xl text-xs font-bold shrink-0 transition-all flex items-center gap-1.5 ${
                  isSelected
                    ...
                    : "bg-[#27272A] text-[#FAFAFA] border border-[#27272A] hover:border-zinc-400"
                }`}
              >
        ...
        {/* Timeline List */}
        {loading ? (
          <div className="py-12 text-center text-zinc-400 text-xs animate-pulse font-mono">
          ...
          <div className="space-y-4">
            {displayWeeks.map((week) => {
              ...
              return (
                <div
                  key={week.weekNumber}
                  className={`bg-[#18181B] border rounded-3xl transition-all shadow-sm ${
                    isCurrentActive
                      ? "border-black"
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="w-10 h-10 rounded-2xl bg-[#27272A] text-[#FAFAFA] font-black text-sm flex items-center justify-center shrink-0 border border-[#27272A] shadow-sm">
                        W{week.weekNumber}
                      </span>
                      ...
                      <div>
                        ...
                        <h3 className="text-sm font-black text-[#FAFAFA] mt-0.5">
                          {week.focusTitle}
                        </h3>
                      </div>
                    </div>
                  ...
                  {isCurrentActive && (
                    <div className="px-5 pb-5 pt-2 border-t border-[#27272A] space-y-4">
                      <div>
                        <h4 className="text-[10px] font-black uppercase tracking-wider text-zinc-400 mb-2">
                          Action Checklist
                        </h4>
                            ...
                            return (
                              <label
                                ...
                                className={`flex items-start gap-3 p-3.5 rounded-2xl border text-xs cursor-pointer transition-all ${
                                  isDone
                                    ? "bg-[#27272A] border-[#27272A] text-zinc-400 line-through"
                                    : "bg-[#09090B] border-[#27272A] text-[#FAFAFA] hover:border-zinc-400"
                                }`}
                              >
                                <input
                                  type="checkbox"
                                  ...
                                  className="mt-0.5 rounded text-[#FAFAFA] accent-[#FAFAFA]"
                                />
                      ...
                      {/* Milestone Card */}
                      <div className="p-4 bg-[#09090B] border border-[#27272A] rounded-2xl flex items-center justify-between gap-3 shadow-sm">
                        <div>
                          <span className="text-[10px] font-black uppercase tracking-wider text-zinc-400">
                            Week {week.weekNumber} Milestone Target
                          </span>
                          <p className="text-xs font-black text-[#FAFAFA] mt-0.5">
                            🎯 {week.milestone}
                          </p>
                        </div>
                      </div>
